...
namespace Uebung1.ValueTypes
{
    public class TypeExercise
    {
        ...
        {
            decimal preis = nettopreis * steuerProdukt ?? nettopreis * steuerKategorie ?? nettopreis * (decimal)1.2; //nettopreis(1.2M) M..Money
            return preis;
        ...
        {
            double AvgAnz = (schuelerGesamt * 1.00) / klassenGesamt; //1.00 damit eine Kommazahl kommmt, ansonsten würde nur 16 rauskommen
            return AvgAnz;
        ...
        Kann in dieser Funktion eine Exception auftreten Nein
